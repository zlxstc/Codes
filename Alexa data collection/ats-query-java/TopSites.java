...
public class TopSites {
    ...
    protected static int Maximum_number = 999;
    protected int START_NUMBER = START+ Iterations*NUMBER_TO_RETURN;
     ...
     * @return 
     */
    private static StringBuffer parseResponse(InputStream in) throws Exception {
        // Parse the response
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            writer = new BufferedWriter(new OutputStreamWriter(
                  new FileOutputStream("Top100,000.txt"), "utf-8"));
	        // Iterations
		    while(Iterations<Maximum_number) {
